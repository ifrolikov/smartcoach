...
<div class="popup" id="popup1">
    ...
    <div class="content">
		...
		<a class="btn whatsup" href="whatsapp://call?number=<?=preg_replace('~[^\d]+~', '', ConfigFacade::getPhone())?>">
...
<div class="body-blocks">
    ...
    <div class="body-block">
        <div class="container">
            <h2>Как я работаю</h2>
            <iframe width="100%" height="360px" src="https://www.youtube.com/embed/qMzLDJwoEL4?ecver=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
            <?= $data ?>
        </div>
    </div>
    <?php } ?>
