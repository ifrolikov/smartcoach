...
return [
    ...
    \ifrolikov\dto\Interfaces\DtoBuilderInterface::class => function (\Psr\Container\ContainerInterface $container) {
    ...
    \app\repository\SocialNetworks::class => function (\Psr\Container\ContainerInterface $container) {
